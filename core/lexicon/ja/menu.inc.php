...
$_lang['description_desc'] = 'メニュー内でこのページの説明に使用されるテキスト、またはレキシコンキー。';
...
$_lang['lexicon_key_desc'] = 'メニューでこのページのタイトルに使用されるテキスト、またはレキシコンキー。';
...
$_lang['permissions_desc'] = 'このメニュー項目のロードに必要なパーミッションキー。';
